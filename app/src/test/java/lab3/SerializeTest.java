...
public class SerializeTest {
    ...
    public void test(WebDriver driver, JavascriptExecutor js) throws InterruptedException {
        ...
        WebElement inputElement = driver.findElement(By.xpath("/html/body/main/section[3]/div/div/div[4]/article/a[1]"));
        ...
        WebElement result = driver.findElement(By.xpath("/html/body/main/div/div[2]/div[2]/div[2]/form/div/div/pre"));
        Assert.assertEquals("s:9:\"yesyesyes\";", result.getText());
    }
}
