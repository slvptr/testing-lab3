...
public class JsonEncodeTest {
    ...
    @Test
    public void jsonEncode() throws InterruptedException {
    ...
    public void test(WebDriver driver, JavascriptExecutor js) throws InterruptedException {
        ...
        WebElement inputElement = driver.findElement(By.xpath("/html/body/main/section[3]/div/div/div[1]/article/a[1]"));
        ...
        WebElement result = driver.findElement(By.xpath("/html/body/main/div/div[2]/div[2]/div[2]/form/div/div/div"));
        Assert.assertEquals("\"yesyesyes\"", result.getText());
    }
}
